...
function validateAge2() {
    ...
    var msg;
    var parentId = "calculator-row-14";
    var elementName = "eosError";
...
function showResult() {
    ...
    if (result > 100) {
        div2.innerHTML = '🚶‍♂️🚶‍♀️🚶‍♂️🚶🏿🚶‍♂️🚶‍♀️🚶‍♂️ Based on your profile, you are in priority Group 12, and there are between 44,522 and 87,400 people in front of you in the queue for a first dose of COVID vaccine across Wales.'
        div3.innerHTML = "📅 Given a vaccination rate of 150,000 a week and an uptake of 85%, you should expect to receive your first dose of vaccine by 18/01/2023."
        div4.innerHTML = "You should then get your second dose by 08/04/2023."
